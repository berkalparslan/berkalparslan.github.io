...
(function () {
  ...
  defineTemplate({ key: 'sive', name: 'Sive', desc: T('Beyaz zeminde büyük mor kartlar: başlık kartı, özellik kartları ve laurel kartı. Alışkanlık ve sağlık uygulamaları için bento düzeni.', 'Large purple cards on white: a headline card, feature cards and a laurel card. A bento layout for habit and wellness apps.'),
    ...
    style: { font: 'inter', weight: 800, size: 9, color: '#ffffff', accent: '#ffffff', letterSpacing: -2.5, lineHeight: 1.0, subSize: 3, subColor: '#ffffff', subOpacity: 95, titleBox: { x: 8, y: 8, w: 84, h: 30, valign: 'middle' }, subBox: { x: 8, y: 42, w: 84 } },
    bg: { type: 'solid', c1: '#ffffff' }, device: { frame: 'iphone-pro', color: 'black', shadow: 40, fit: 'top' },
    screens: S8([
      ['text-top', '#1\nHabit\nTracking', '#1\nAlışkanlık\nTakibi', 'create your perfect daily routine', 'mükemmel günlük rutinini kur', { dev: null, els: [
        { kind: 'shape', shape: 'rect', x: 50, y: 26, w: 92, h: 47, color: '#7b5cf5', radius: 5, opacity: 100 },
        { kind: 'shape', shape: 'rect', x: 27, y: 66, w: 45, h: 24, color: '#7b5cf5', radius: 5, opacity: 100 }, { kind: 'shape', shape: 'rect', x: 73, y: 66, w: 45, h: 24, color: '#7b5cf5', radius: 5, opacity: 100 },
        { kind: 'emoji', x: 27, y: 63, size: 5, text: '🌳' }, { kind: 'emoji', x: 73, y: 63, size: 5, text: '🔥' },
        ...
        { kind: 'shape', shape: 'rect', x: 50, y: 89, w: 92, h: 18, color: '#7b5cf5', radius: 5, opacity: 100 }, { kind: 'laurel', x: 50, y: 89, size: 2.2, text: T('100.000+\nKULLANICI', '100,000+\nUSERS'), sub: '★★★★★', color: '#ffffff' }] }],
      ['text-top', 'Build\nroutines', 'Rutin\nkur', 'morning, day and night', 'sabah, gün ve gece', { titleBox: { x: 8, y: 6, w: 84, h: 18, valign: 'middle' }, subBox: { x: 8, y: 25, w: 84 }, dev: { x: 15, y: 33, w: 70 }, els: [{ kind: 'shape', shape: 'rect', x: 50, y: 17, w: 92, h: 26, color: '#7b5cf5', radius: 5, opacity: 100 }] }],
      ['text-top', 'Track\nstreaks', 'Serileri\ntakip et', 'stay consistent', 'tutarlı kal', { titleBox: { x: 8, y: 6, w: 84, h: 18, valign: 'middle' }, subBox: { x: 8, y: 25, w: 84 }, dev: { x: 15, y: 33, w: 70 }, els: [{ kind: 'shape', shape: 'rect', x: 50, y: 17, w: 92, h: 26, color: '#7b5cf5', radius: 5, opacity: 100 }] }],
      ['text-top', 'Gentle\nreminders', 'Nazik\nhatırlatma', 'at the right time', 'doğru anda', { titleBox: { x: 8, y: 6, w: 84, h: 18, valign: 'middle' }, subBox: { x: 8, y: 25, w: 84 }, dev: { x: 15, y: 33, w: 70 }, els: [{ kind: 'shape', shape: 'rect', x: 50, y: 17, w: 92, h: 26, color: '#7b5cf5', radius: 5, opacity: 100 }] }],
      ['text-top', 'See your\nprogress', 'İlerlemeni\ngör', 'weekly and monthly', 'haftalık ve aylık', { titleBox: { x: 8, y: 6, w: 84, h: 18, valign: 'middle' }, subBox: { x: 8, y: 25, w: 84 }, dev: { x: 15, y: 33, w: 70 }, els: [{ kind: 'shape', shape: 'rect', x: 50, y: 17, w: 92, h: 26, color: '#7b5cf5', radius: 5, opacity: 100 }] }],
      ['text-top', 'Mood\njournal', 'Ruh hâli\ngünlüğü', 'one tap a day', 'günde bir dokunuş', { titleBox: { x: 8, y: 6, w: 84, h: 18, valign: 'middle' }, subBox: { x: 8, y: 25, w: 84 }, dev: { x: 15, y: 33, w: 70 }, els: [{ kind: 'shape', shape: 'rect', x: 50, y: 17, w: 92, h: 26, color: '#7b5cf5', radius: 5, opacity: 100 }] }],
      ['text-top', 'Widgets\n& watch', 'Widget\nve saat', 'tick from anywhere', 'her yerden işaretle', { titleBox: { x: 8, y: 6, w: 84, h: 18, valign: 'middle' }, subBox: { x: 8, y: 25, w: 84 }, dev: { x: 15, y: 33, w: 70 }, els: [{ kind: 'shape', shape: 'rect', x: 50, y: 17, w: 92, h: 26, color: '#7b5cf5', radius: 5, opacity: 100 }] }],
      ['text-top', 'Start\ntoday', 'Bugün\nbaşla', 'free, no ads', 'ücretsiz, reklamsız', { titleBox: { x: 8, y: 6, w: 84, h: 18, valign: 'middle' }, subBox: { x: 8, y: 25, w: 84 }, dev: { x: 15, y: 33, w: 70 }, els: [{ kind: 'shape', shape: 'rect', x: 50, y: 17, w: 92, h: 26, color: '#7b5cf5', radius: 5, opacity: 100 }] }],
    ]) });
